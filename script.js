...
const validation = () => {
  if (amountOneElm.value <= 0) {
    ...
    rateElm.style.color = "#e40101"
    rateElm.style.fontSize = "15px";
...
async function calculate() {
  ...
  await fetch(`https://v1.nocodeapi.com/rayan2228/cx/LPHapxmkyFYalsnp/rates/convert?amount=100&from=${currencyOneVal}&to=${currencyTwoVal}`)
